...
for ($swop=1; $swop <= $jml_swop; $swop++){
        ...
        //echo "Halaman Baru<br />";
		 ...
		 $x_point3 = 235;
            ...
            $pdf->useTemplate($templateId8, $x_point3, $y_point1, $lebar, $tinggi, true);
            $pdf->useTemplate($templateId5, $x_point4, $y_point1, $lebar, $tinggi, true);
		 $pdf->useTemplate($templateId9, $x_point1, $y_point2, $lebar, $tinggi, true);
            $pdf->useTemplate($templateId12, $x_point2, $y_point2, $lebar, $tinggi, true);
            $pdf->useTemplate($templateId16, $x_point3, $y_point2, $lebar, $tinggi, true);
            $pdf->useTemplate($templateId13, $x_point4, $y_point2, $lebar, $tinggi, true);

            $pdf->addPage('L',array(470,320)); 
            $pdf->useTemplate($templateId6, $x_point1, $y_point1, $lebar, $tinggi, true);
            $pdf->useTemplate($templateId7, $x_point2, $y_point1, $lebar, $tinggi, true);
            $pdf->useTemplate($templateId3, $x_point3, $y_point1, $lebar, $tinggi, true);
            $pdf->useTemplate($templateId2, $x_point4, $y_point1, $lebar, $tinggi, true);
		 $pdf->useTemplate($templateId14, $x_point1, $y_point2, $lebar, $tinggi, true);
            $pdf->useTemplate($templateId15, $x_point2, $y_point2, $lebar, $tinggi, true);
            $pdf->useTemplate($templateId11, $x_point3, $y_point2, $lebar, $tinggi, true);
            $pdf->useTemplate($templateId10, $x_point4, $y_point2, $lebar, $tinggi, true);
